...
import static com.trs.cc.discountcode.constant.MessageConstants.TOKEN_NOT_FOUND;
...
public class Utils {
    ...
    public static List<DiscountCodeAPI> getAllMethodNames(Class className) {
        Method[] allMethods = className.getDeclaredMethods();
        List<DiscountCodeAPI> apis = new ArrayList<DiscountCodeAPI>();
        for (Method method : allMethods) {
            ...
            if (Modifier.isPublic(method.getModifiers())) {
                ...
                DiscountCodeAPI api = new DiscountCodeAPI();
                api.setName(rm.name());
